...
# Mars Mission Recycling information for each material
RECYCLING_INFO = {
    "Aluminium": {
...
st.markdown("**Mission Control: Capture materials and discover how to recycle them for Mars colonization!**")

# Main camera interface
st.subheader("📸 Mars Material Scanner")
camera_input = st.camera_input("Scan Mars mission materials for recycling analysis")
...
if camera_input is not None:
    ...
    st.markdown("""
    1. **Activate Mars Material Scanner** by clicking the camera above
    2. **Scan mission materials** (spacecraft parts, habitat components, equipment)
    3. **Capture clear image** of the material
    4. **Get instant Mars recycling protocol** and mission applications!
    """)
